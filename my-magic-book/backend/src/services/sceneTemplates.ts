...
export const SCENE_TEMPLATES: Record<string, SceneTemplate> = {
  ...
  world_adventure: {
    ...
    pageScenes: [
      ...
      'at a fork in the desert path, the friendly camel pointing with his head between two ways — a colorful striped hot-air balloon waiting on one side, dense green rainforest on the other — hand on chin, thinking hard. Mishmish is ALWAYS the same camel: a young golden-tan camel with one hump, large dark friendly eyes, long lashes and a woven turquoise-and-red blanket on his back — never a different camel, wearing a mustard-yellow explorer jacket over a white t-shirt, blue jeans and a small red backpack — the SAME outfit on every page, never the clothes from the reference photo',
      ...
      'close to camera with face clearly visible and warmly lit, crouching on a sunny Japanese beach lined with pink sakura trees in blossom, petals on the sand; a small golden compass nestled among the seashells nearby, wearing a mustard-yellow explorer jacket over a white t-shirt, blue jeans and a small red backpack — the SAME outfit on every page, never the clothes from the reference photo',
      'sitting in a circle with smiling children from many countries in their traditional clothes, everyone laughing together, small flags and a warm open square around them, wearing a mustard-yellow explorer jacket over a white t-shirt, blue jeans and a small red backpack — the SAME outfit on every page, never the clothes from the reference photo',
  ...
  deep_sea: {
    ...
    pageScenes: [
      ...
      'ONE single child alone in the frame, floating beside a friendly dolphin who is speaking earnestly, dim moonlit water and rocks below, a faint empty socket where a pearl should sit. Bobo is ALWAYS the same dolphin: a sleek blue-grey bottlenose with a pale cream belly, a small notch on his dorsal fin and warm dark eyes — never a different dolphin, wearing the SAME grey denim shirt and dark cap as every other page and as part 1 of this series, never the clothes from the reference photo',
      'at an underwater fork between two routes — a fast sleek dolphin poised on one side, a large calm sea turtle on the other — hand on chin, thinking hard, coral either side. Bobo is ALWAYS the same dolphin: a sleek blue-grey bottlenose with a pale cream belly, a small notch on his dorsal fin and warm dark eyes — never a different dolphin. the wise turtle is ALWAYS the same: a large old green sea turtle with a mossy patterned shell, gentle heavy-lidded eyes and slow wide flippers — never a different turtle, wearing the SAME grey denim shirt and dark cap as every other page and as part 1 of this series, never the clothes from the reference photo',
      ...
      'gathering tangled plastic bags out of the coral into a mesh net, small fish helping alongside, a determined caring expression, clear blue water, wearing the SAME grey denim shirt and dark cap as every other page and as part 1 of this series, never the clothes from the reference photo',
  ...
  little_chef: {
    ...
    pageScenes: [
      'in a bright modern family kitchen with pale wood counters and a sunny window, tying on a checked apron with a big excited grin, morning light across the counter, mother smiling beside them. the mother is ALWAYS the same woman: warm smile, dark hair tied back, a simple olive-green blouse and a plain cream apron — never a different woman, wearing a small red-and-white checked apron over a white t-shirt and blue jeans — the SAME outfit on every page, never the clothes from the reference photo',
      ...
      'slicing a cucumber into even rounds on a wooden board with a chunky CHILD-SAFE PLASTIC knife (never a real metal blade), tongue-out concentration, mother\'s hands steadying the board alongside. the mother is ALWAYS the same woman: warm smile, dark hair tied back, a simple olive-green blouse and a plain cream apron — never a different woman, wearing a small red-and-white checked apron over a white t-shirt and blue jeans — the SAME outfit on every page, never the clothes from the reference photo',
      ...
      'the family around the table tasting the food and praising it, everyone laughing, the young cook glowing with pride. the mother is ALWAYS the same woman: warm smile, dark hair tied back, a simple olive-green blouse and a plain cream apron — never a different woman, wearing a small red-and-white checked apron over a white t-shirt and blue jeans — the SAME outfit on every page, never the clothes from the reference photo',
