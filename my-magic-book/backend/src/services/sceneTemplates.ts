...
export const SCENE_TEMPLATES: Record<string, SceneTemplate> = {
  ...
  toy_city: {
    ...
    pageScenes: [
      ...
      'at the very top of the brick tower, holding a small battery marked with a smile and beaming an honest grin at it as it bursts into rainbow-colored light, clouds and open sky around the tower top, wearing a bright red hoodie with a small yellow star on the chest, denim shorts and blue sneakers — the SAME outfit on every page, never the clothes from the reference photo',
      'joyfully handing the glowing smile-battery to the little robot Tiki, whose eyes light up bright as he leaps and dances with happiness, tiny colorful bricks confetti in the air, wearing a bright red hoodie with a small yellow star on the chest, denim shorts and blue sneakers — the SAME outfit on every page, never the clothes from the reference photo',
      ...
      'the little robot Tiki waving goodbye with a gentle smile as the toy city softly glows and begins to fade, warm sunset light, a touch wistful, wearing a bright red hoodie with a small yellow star on the chest, denim shorts and blue sneakers — the SAME outfit on every page, never the clothes from the reference photo',
    ...
    portraitScene: 'in the magical Toy City holding the golden toy key, the little robot Tiki and bright brick houses softly blurred behind, wearing a bright red hoodie with a small yellow star on the chest, denim shorts and blue sneakers — the SAME outfit on every page, never the clothes from the reference photo',
  },
  zoo_adventure: {
    style: 'photoreal',
