...
export const SCENE_TEMPLATES: Record<string, SceneTemplate> = {
  ...
  magic_book: {
    ...
    pageScenes: [
      ...
      'with the whole body clearly visible and joyfully floating as if gently lifted into the air, swept up inside a breathtaking swirling magical vortex of glowing golden light and colorful sparkling ribbons, with hundreds of softly glowing letters spiraling all around, a dreamy weightless sense of flight and wonder, dynamic cinematic magical portal',
