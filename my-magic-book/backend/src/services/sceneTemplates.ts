...
export const SCENE_TEMPLATES: Record<string, SceneTemplate> = {
  ...
  toy_city: {
    ...
    pageScenes: [
      ...
      'standing at the very top of a tall tower built of bright colorful interlocking building bricks, holding up a small chunky battery with a smiley face printed on it and beaming an honest grin at it as it bursts into rainbow-colored light, the brick-built toy city spread out far below, blue sky and a few soft clouds, wearing a bright red hoodie with a small yellow star on the chest, denim shorts and blue sneakers — the SAME outfit on every page, never the clothes from the reference photo',
