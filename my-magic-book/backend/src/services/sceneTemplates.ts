...
export const SCENE_TEMPLATES: Record<string, SceneTemplate> = {
  ...
  deep_sea: {
    ...
    pageScenes: [
      ...
      'ONE single child alone in the frame, floating beside a friendly dolphin who is speaking earnestly, dim moonlit water and rocks below, a faint empty socket where a pearl should sit. Bobo is ALWAYS the same dolphin: a sleek blue-grey bottlenose with a pale cream belly, a small notch on his dorsal fin and warm dark eyes — never a different dolphin, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      'at an underwater fork between two routes — a fast sleek dolphin poised on one side, a large calm sea turtle on the other — hand on chin, thinking hard, coral either side. Bobo is ALWAYS the same dolphin: a sleek blue-grey bottlenose with a pale cream belly, a small notch on his dorsal fin and warm dark eyes — never a different dolphin. the wise turtle is ALWAYS the same: a large old green sea turtle with a mossy patterned shell, gentle heavy-lidded eyes and slow wide flippers — never a different turtle, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      'swimming calmly alongside the big old sea turtle through a beautiful valley of tall colorful coral, shafts of sunlight from above. the wise turtle is ALWAYS the same: a large old green sea turtle with a mossy patterned shell, gentle heavy-lidded eyes and slow wide flippers — never a different turtle, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      ...
      'setting the glowing pearl back into its socket as the entire deep bursts into blue and pink light, coral and fish illuminated in every direction, awestruck, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      'close to camera with face clearly visible and warmly lit, in the middle of a joyful underwater celebration of fish, seahorses and rays; a small glowing pink shell tucked among the coral nearby, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      'gathering tangled plastic bags out of the coral into a mesh net, small fish helping alongside, a determined caring expression, clear blue water, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      'face to face with the dolphin and a huge gentle whale, hands raised mid-signal, soft musical ripples in the water. Bobo is ALWAYS the same dolphin: a sleek blue-grey bottlenose with a pale cream belly, a small notch on his dorsal fin and warm dark eyes — never a different dolphin, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      'receiving a bright shell necklace from a stately sea king with a coral crown, a tender ceremonial moment, glowing pearl light behind, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
      ...
      'sitting on the sunny beach sand, the blue shell beside one hand and the shell necklace around the neck, smiling out at the calm sea, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
    ],
    coverScene: 'the child close to camera, face large, clearly visible and warmly lit, smiling with excitement, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo; behind them the lit deep ocean — a glass bubble submarine, a friendly dolphin, a great sea turtle, glowing coral and a radiant pearl casting blue and pink light through the water. the child is lit by the same warm light as the scene and blends naturally into it, real skin tones, soft contact shadows, never a flat cut-out pasted on top',
    portraitScene: 'underwater holding the bright shell necklace, the dolphin and glowing coral softly blurred behind, wearing a bright teal wetsuit with a white stripe down each arm and a small silver diving watch — the SAME outfit on every page, never the clothes from the reference photo',
  },
  zoo_adventure: {
    style: 'photoreal',
