...
export const schoolAdventure: StoryDefinition = {
  id: 'school_hero',
  order: 3,
  titleAr: 'مغامرة [NAME]: بطل{|ة} المدرسة',
  ...
  questionsAr: [
    'كيف أعاد{|ت} [NAME] الألوان لمدرست{ه|ها}؟',
    'ماذا فعل{|ت} [NAME] لإنقاذ القطة الصغيرة؟',
    'كيف يمكنك أنت أيضاً أن تكون{|ي} بطل{اً|ة} في مدرستك؟',
  ],
  conclusionAr: 'أنت بطل{|ة} رائع{|ة} يا [NAME]! تذكر{|ي} دائماً أن اللطف يجعل العالم أكثر جمالاً وألواناً. 🏆✨',
  dedicationAr: 'إلى بطل{نا|تنا} الصغير{|ة} [NAME]، {الذي|التي} {يثبت|تثبت} لنا كل يوم أن القوة الحقيقية تبدأ من مساعدة الآخرين ونشر الابتسامة.',
