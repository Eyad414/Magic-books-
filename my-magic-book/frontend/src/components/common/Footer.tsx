        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="https://www.tiktok.com/@magic.fanoos" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-gold-500 hover:border-gold-500/40 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-4 h-4">
              ...
              <a href="mailto:hello@magicfanoos.com" aria-label="Email" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-gold-500 hover:border-gold-500/40 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-white/50 text-sm font-arabic">
                ...
                <span>hello@magicfanoos.com</span>
              </li>
              <li className="flex items-center gap-3 text-white/50 text-sm font-arabic">
