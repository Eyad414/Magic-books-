...
export default function StoryBook({
  ...
  return (
    <div className="sb-root" dir={i18n.dir()}>
      ...
      {/* 3 — Fanoose Separator */}
      <FanoosPage label={t('storybook.fanoos_start', 'فانوس البداية')} image="/lantern-start.jpg" />
      ...
      <FanoosPage label={t('storybook.fanoos_end', 'فانوس النهاية')} image="/lantern-end.jpg" />
