              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="mt-8 p-4 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <p className="font-arabic text-white/40 text-xs mb-4">{t('admin.home_stats_hint', 'الأرقام تحت العنوان في الصفحة الرئيسية — اكتب فيها ما يمكن إثباته فقط')}</p>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      {[
                        { key: 'readyStories', label: t('hero.stats_ready_stories'), def: '20' },
                        { key: 'languages', label: t('hero.stats_languages'), def: '3' },
                        { key: 'pages', label: t('hero.stats_pages'), def: '13' },
                        { key: 'pickup', label: t('hero.stats_pickup'), def: 'القدس' },
                      ].map((s) => (
                        <div key={s.key}>
